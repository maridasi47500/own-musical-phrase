class WelcomeController < ApplicationController
  ...
  def song
       ...
       browser.close
       @newscore=Newscore.new(title: title, time_signature: time, key_signature: key+" "+mode, metronomemark: bpm)
       @newscore.save
       @fragment=Fragment.new(title: title, time_signature: time, key_signature: key+" "+mode, tempo: bpm)
       if @fragment.save
